class ArticleCategory < ActiveRecord::Base
  ...
  has_attached_file :top_banner_ad, {:styles => { :thumb => "48x36>", :small => "85x55>", :medium => "9999>x93", :large => "880x9999>", :slide => "550x9999>" }}.merge(PAPERCLIP_OPS)
  
  attr_accessor :remove_alt_logo
  attr_accessor :remove_top_banner_ad
end